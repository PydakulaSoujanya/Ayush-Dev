...
<div class="col-12 col-sm-6 col-md-3 col-lg-3 mt-3" id="vendorFields" style="display: none;">
  <div class="input-field-container">
    ...
    <select name="vendor_id" id="vendor_name" class="styled-input form-control">
...
<div class="col-12 col-sm-6 col-md-3 col-lg-3 mt-3" id="vendorContactField" style="display: none;">
  ...
  <div class="col-12 col-sm-6 col-md-3 col-lg-3 mt-3">
    <div class="input-field-container">
      ...
      <input type="text" id="beneficiary_name" name="beneficiary_name" class="styled-input" placeholder="Enter Beneficiary Name" readonly/>
    </div>
  </div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch("fetch_vendor_data.php")
        ...
        .then(data => {
            if (data.error) {
                console.error("Error fetching vendor data:", data.error);
                return;
            }
            ...
            data.forEach(vendor => {
                ...
                option.value = vendor.id; // Use the vendor ID as the value
                option.text = vendor.vendor_name; // Display the vendor name
                ...
                option.dataset.beneficiaryName = vendor.beneficiary_name; // Include beneficiary_name
            ...
            vendorNameSelect.addEventListener("change", function () {
                ...
                if (selectedOption) {
                    ...
                    document.getElementById("beneficiary_name").value = selectedOption.dataset.beneficiaryName || ""; // Populate beneficiary_name
                }
            });
        })
...
document.getElementById("vendor_name").addEventListener("change", function () {
    ...
    document.getElementById("vendor_name_hidden").value = selectedOption.text; // Set the vendor name
});
