                ...
                foreach ($data as $index => $row) { ?>
                  <tr>
                    ...
                    <td class="action-icons">
                      ...
                      <a href="update_service_master.php?id=<?php echo $row['id']; ?>"><i class="fa-solid fa-edit" style="color: black;"></i></a>
                      <a href="delete_servicemaster.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete?')"><i class="fa-solid fa-trash" style="color: black;"></i></a>
                    </td>
                  </tr>
              <?php } 
              } else { ?>
