...
<div class="container mt-7">
  ...
  <form action="advance_db.php" method="POST" enctype="multipart/form-data">
    <div class="row">
...
<input type="text" id="emp_id" name="emp_id" placeholder="Employee ID" style="width: 100%; margin-top: 10px;" readonly required>
<input type="text" id="emp_name_input" name="emp_name_input" placeholder="Employee Name" style="width: 100%; margin-top: 10px;" readonly required>
  </div>
</div>
      ...
      <div class="col-md-4">
        <div class="input-field-container">
          ...
          <input type="date" class="styled-input" name="advance_paid_date" required />
        </div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="input-field-container">
          ...
          <input type="number" class="styled-input" name="amount_paid" placeholder="Enter Amount Paid" required />
        </div>
      </div>
...
<div class="col-md-4">
    ...
    <input type="hidden" name="advance paid_type" value="Employee advance paid Claim">
    </div>
    <div class="row">
...
function updateEmployeeFields() {
  ...
  document.getElementById("emp_id").value = employeeId;
  document.getElementById("emp_name_input").value = employeeName;
}
</script>
<script>
