...
if (isset($_GET['id'])) {
    ...
    if ($resultCustomer->num_rows > 0) {
        ...
        echo "<tr><th>Discharge Summary</th><td><a href='uploads/{$customer['discharge_summary_sheet']}' target='_blank'>View File</a></td></tr>";        echo "<tr><th>Created At</th><td>{$createdAt}</td></tr>";
