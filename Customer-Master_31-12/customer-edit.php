...
<div class="container mt-7">
  ...
  <form action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="input-field-container">
          ...
          <input type="text" class="styled-input" name="pincode" placeholder="Enter pincode" value="<?= htmlspecialchars($addressData['pincode']); ?>" required />
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="input-field-container">
          ...
          <input type="text" class="styled-input" name="address_line1" placeholder="Enter address line 1" value="<?= htmlspecialchars($addressData['address_line1']); ?>" required />
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="input-field-container">
          ...
          <input type="text" class="styled-input" name="address_line2" placeholder="Enter address line 2" value="<?= htmlspecialchars($addressData['address_line2']); ?>" />
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="input-field-container">
          ...
          <input type="text" class="styled-input" name="landmark" placeholder="Enter landmark" value="<?= htmlspecialchars($addressData['landmark']); ?>" />
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="input-field-container">
          ...
          <input type="text" class="styled-input" name="city" placeholder="Enter city" value="<?= htmlspecialchars($addressData['city']); ?>" required />
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="input-field-container">
          ...
          <input type="text" class="styled-input" name="state" placeholder="Enter state" value="<?= htmlspecialchars($addressData['state']); ?>" required />
        </div>
      </div>
    </div>
    ...
    <div class="mt-4">
      ...
      <a href="customer_table.php" class="btn btn-secondary">Cancel</a>
    </div>
  </form>
</div>
