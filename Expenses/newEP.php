            ...
            if (mysqli_num_rows($empPayoutRefrenceDetailsResult) > 0) {
                ...
                while ($row = mysqli_fetch_assoc($empPayoutRefrenceDetailsResult)) {
                    ...
                    echo "<tr>
                        ...
                        <td>
                            <a href='view.php?id={$row['expense_id']}' class='btn btn-info btn-sm'>View</a>
                            <a href='edit.php?id={$row['expense_id']}' class='btn btn-warning btn-sm'>Edit</a>
                            <a href='delete.php?id={$row['expense_id']}' class='btn btn-danger btn-sm' onclick='return confirm(\"Are you sure you want to delete this record?\")'>Delete</a>
                        </td>
                    </tr>";
                }
            } else {
