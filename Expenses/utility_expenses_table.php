...
<div class="container mt-7">
  <div class="dataTable_card card">
    <div class="card-header d-flex justify-content-between align-items-center">
      <h5 class="mb-0 table-title">Utility Expenses Info </h5>
      <a href="utility_expenses.php"  class="add_button"><strong class="add_button_plus">+</strong> Add Utility Expense </a>
    </div>
